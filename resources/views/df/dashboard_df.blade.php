            ...
            if (str == "") {
                ...
                xmlhttp.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        var referencerec = document.getElementById("referencerec");
                        modal = $("#updateModal");
                        modal.find('.modal-body #id').val(reclamation.id);
                        modal.find('.modal-body #referencerec').val(reclamation.referencerec);
...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <!-- End header header -->
        <!-- Left Sidebar  -->
        @include('df/left_sidebar')
        <!-- End Left Sidebar  -->
        <!-- Page wrapper  -->
        <div class="page-wrapper">
            <!-- Bread crumb -->
            @include('df/sous_en_tete')
            <!-- End Bread crumb -->
            <!-- Container fluid  -->
            @include('df/tableau_reclamation')    
        </div>
    </div>
