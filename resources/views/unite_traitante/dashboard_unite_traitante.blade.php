...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <!-- End header header -->
        <!-- Left Sidebar  -->
        @include('unite_traitante/left_sidebar')
        <!-- End Left Sidebar  -->
        <!-- Page wrapper  -->
        <div class="page-wrapper">
            <!-- Bread crumb -->
            @include('unite_traitante/sous_en_tete')
            <!-- End Bread crumb -->
            <!-- Container fluid  -->
            @include('unite_traitante/tableau_reclamation')    
        </div>
    </div>
    
    @include('unite_traitante/modal_update_reclamation')
