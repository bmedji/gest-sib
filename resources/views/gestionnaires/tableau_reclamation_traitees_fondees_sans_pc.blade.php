...
<div class="table-responsive m-t-40">
    <div id="example23_wrapper" class="dataTables_wrapper"><table id="tableau_reclamation_gestionnaire_traite_fondees_sans_pc" class="display nowrap table table-hover table-striped table-bordered dataTable" cellspacing="0" width="100%" role="grid" aria-describedby="example23_info" style="width: 100%;">
        <thead>
        ...
        <tbody>
        @foreach($reclamations_clients_gestionnaires_traitees_fondees_sans_pc as $reclamation_client)
