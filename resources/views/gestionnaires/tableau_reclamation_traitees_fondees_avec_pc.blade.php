...
<div class="table-responsive m-t-40">
    <div id="example23_wrapper" class="dataTables_wrapper"><table id="tableau_reclamation_gestionnaire_traite_fondees_avec_pc" class="display nowrap table table-hover table-striped table-bordered dataTable" cellspacing="0" width="100%" role="grid" aria-describedby="example23_info" style="width: 100%;">
        <thead>
        ...
        <tbody>
        @foreach($reclamations_clients_gestionnaires_traitees_fondees_avec_pc as $reclamation_client)
        ...
        <tr role="row" style="text-align: center;" >
                ...
                <td id="pc_{{$reclamation_client->PieceComptable}}"><a target="_blank" href="/find/{{$reclamation_client->PieceComptable}}"><i class="fa fa-download"></i></a></td>
                <td>
